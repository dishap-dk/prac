...
const {isValidBody,isValid,isValidObjectId}= require ("../utils/validation.js")
...
const updateProduct = async (req, res) => {
 ...
 module.exports= {createProduct,getProductsById,getByFilter,updateProduct,deleteProduct}